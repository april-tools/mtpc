...
python mtp/tables/table_2_throughput_longer.py --raw-throughput-file outputs/results/L40S/throughput-llama-full-run-10-10.jsonl --spec-throughput-file outputs/results/L40S/throughput-llama-sampling-no-lora-1024-250.jsonl

## Greedy decoding
# Table 1  #  TODO: Fix the STP passed in
python mtp/tables/table_1_cp_rank_comparison.py --raw-throughput-file outputs/results/L40S/throughput_evabyte_full-run-100_100.jsonl --spec-throughput-file outputs/results/L40S/throughput-llama-argmax-no-lora-1024-250.jsonl
# Table 2  #  TODO: Fix the STP passed in
python mtp/tables/table_2_throughput_longer.py --raw-throughput-file outputs/results/L40S/throughput-llama-full-run-10-10.jsonl --spec-throughput-file outputs/results/L40S/throughput-llama-argmax-no-lora-1024-250.jsonl
