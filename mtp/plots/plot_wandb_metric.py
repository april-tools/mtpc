...
if __name__ == '__main__':
    ...
    parser.add_argument('--metrics', type=str, choices=['kl_loss_at', 'ce_loss_at'], required=True, help='Which metrics to plot')
    ...
    def run_identifier(r) -> str:
        ...
        entries = [model]
        entries.append(f"n={r.config['model']['n_token']}")
        entries.append(f"r={r.config['model']['n_component']}")
