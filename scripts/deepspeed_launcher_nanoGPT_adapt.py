...
from deepspeed.elasticity import is_torch_elastic_compatible
from deepspeed.launcher.constants import ELASTIC_TRAINING_ID_DEFAULT
...
def main():
    ...
    if not args.enable_elastic_training:
        ...
        from deepspeed.elasticity import DSElasticAgent
